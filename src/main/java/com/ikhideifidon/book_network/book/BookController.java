...
public class BookController {
    ...
    public ResponseEntity<Integer> returnedBorrowBook(@PathVariable("book-id") Integer bookId, Authentication connectedUser) {
        return ResponseEntity.ok(bookService.returnBorrowBook(bookId, connectedUser));
    }

    @PatchMapping("borrow/return/approved/{book-id}")
    public ResponseEntity<Integer> approveReturnBorrowedBook(@PathVariable(name = "book-id") Integer bookId, Authentication connectedUser) {
