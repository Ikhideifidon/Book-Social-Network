...
import com.ikhideifidon.book_network.book.BookRepository;
...
public class FeedbackService {
    ...
    public Integer save(FeedbackRequest request, Authentication connectedUser) {
        Book book = bookRepository.findById(request.bookId()).orElseThrow(() -> new EntityNotFoundException(String.format("No book found with the ID '%d'", request.bookId())));
    ...
    public PageResponse<FeedbackResponse> findAllFeedbackByBook(Integer bookId, int page, int size, Authentication connectedUser) {
        ...
        List<FeedbackResponse> feedbackResponseList = feedbacks
                .stream()
